 ...
 * This file demonstrates how to integrate Cryptokernel with a web frontend
 */

// For React/Vue/Angular applications
export class CryptokernelClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CryptokernelClient(provider, contractAddress);
