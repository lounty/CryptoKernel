...
const contractABI = require("../artifacts/contracts/Cryptokernel.sol/Cryptokernel.json").abi;

program
    .name("cryptokernel-cli")
    .description("CLI tool for Cryptokernel smart contract")
    .version("1.0.0");
